...
public class SpendRepositorySpringJdbc implements SpendRepository {
    ...
    private final SpendDao spendDaoJdbc = new SpendDaoSpringJdbc();
    ...
    public Optional<SpendEntity> findByUsernameAndSpendDescription(String username, String description) {
        ...
        return Optional.ofNullable(
                jdbcTemplate.query("select * from category c join spend s on c.id = s.category_id " +
                        "where s.description = '" + description + "' and s.username='" + username + "'",
                        SpendEntityRowMapper.instance).getFirst());
